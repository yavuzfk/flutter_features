...
// class AirplaneModeChecker extends StatefulWidget {
//   const AirplaneModeChecker({Key? key}) : super(key: key);

//   @override
//   _AirplaneModeCheckerState createState() => _AirplaneModeCheckerState();
// }

// class _AirplaneModeCheckerState extends State<AirplaneModeChecker> {
//   @override
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (status == AirplaneModeStatus.on) {
                    ...
                    showLongToast('You have to turn on Flight Mode');
                    log('OFF');
                  }
                },
              )
